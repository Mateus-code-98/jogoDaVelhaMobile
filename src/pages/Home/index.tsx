...
export const Home: React.FC = () => {
    ...
    return (
        <View style={{ flex: 1, padding: 20 }}>
                ...
                <View style={{ flexDirection: "row", marginBottom: 10, borderBottomWidth: 1, borderBottomColor: "#1D2766", paddingBottom: 10 }}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: 'space-between', flex: 1 }}>
                        ...
                        <View style={{ justifyContent: "center" }}>
                            <RectButton style={{ padding: 5, backgroundColor: "#E51C44", borderRadius: 3 }}>
            ...
            <RectButton onPress={signOut} style={{ padding: 5, backgroundColor: "#E51C44", borderRadius: 3, marginTop: 10 }}>
